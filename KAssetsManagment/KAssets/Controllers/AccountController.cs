...
namespace KAssets.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                model.Password = "";
                return View("~/Views/Home/IndexLogIn.cshtml", model);
            }
            ...
            switch (result)
            {
                ...
                default:
                    model.Password = "";
                    ModelState.AddModelError("", AccountTr.InvalidLoginAttempt);
                    return View("~/Views/Home/IndexLogIn.cshtml", model);
            }
        }
        ...
        public ActionResult Edit(EditUserViewModel model)
        {
            ...
            user.Id = model.Id;
            user.PasswordHash = this.userService.GetById(user.Id).PasswordHash;

            this.userService.Update(user);

            return Redirect("/Account/Details/" + model.Id);
        }
        ...
        public ActionResult Details(string id)
        {
            ...
            var viewModel = new UserDetailsViewModelBase();
            viewModel.Id = user.Id;
            viewModel.AboutMe = user.AboutMe;
            viewModel.Email = user.Email;
            viewModel.FirstName = user.FirstName;
            viewModel.LastName = user.LastName;
            viewModel.SecondName = user.SecondName;
            viewModel.SecurityGroups = user.SecurityGroups.ToList().Select(x => x.Name).ToList();
        ...
        public JsonResult GetUserLocationId(string id)
        {
            ...
            var locId = user.Location != null ? user.LocationId : "";
